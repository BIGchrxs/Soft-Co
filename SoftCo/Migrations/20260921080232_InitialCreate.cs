        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CargoReadinessDate = table.Column<DateOnly>(type: "date", nullable: true),
                    ...
                    InvoiceValueForeign = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    InvoiceValueZar = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountForeign = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderPayments_SupplierOrders_SupplierOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProjects", x => new { x.SupplierOrderId, x.ProjectId });
                    table.ForeignKey(
                        name: "FK_OrderProjects_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderProjects_SupplierOrders_SupplierOrderId",
                        column: x => x.SupplierOrderId,
                        principalTable: "SupplierOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderPayments_PaidDate",
                table: "OrderPayments",
                column: "PaidDate");

            migrationBuilder.CreateIndex(
                name: "IX_OrderPayments_SupplierOrderId",
                table: "OrderPayments",
                column: "SupplierOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderProjects_ProjectId",
                table: "OrderProjects",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierOrders_FulfilmentStatus",
                table: "SupplierOrders",
                column: "FulfilmentStatus");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierOrders_InvoiceDate",
                table: "SupplierOrders",
                column: "InvoiceDate");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierOrders_InvoiceRef",
                table: "SupplierOrders",
                column: "InvoiceRef");
